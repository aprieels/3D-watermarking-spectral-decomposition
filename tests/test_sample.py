...
def insert_extract(filename_in = os.path.join(os.path.dirname(__file__), 'source_models/bunny.ply'), data = [random.randrange(2) for _ in range(64)], filename_out = os.path.join(os.path.dirname(__file__), 'watermarked_models/out.obj'), axis = [0, 1, 0], secret=123456, i0 = 3, visual_distance = 2):
